...
static const int64 nTargetTimespan = 1 * 60 * 60; // piecoin: 1 hour(s)
static const int64 nTargetSpacing = 180; // piecoin: 3 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Superbowl in Vegas!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1653156080; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1653156080;
            block.nNonce   = 440824;
        }
